                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                                ...
                                {!! Form::select('type', $dec_type, old('type'), ['id'=>'type', 'class' => 'form-control', 'data-toggle'=>'select2']) !!}
                                @if($errors->has('type'))
                                    <div class="mt-1 require_error">
                                        {{ $errors->first('type') }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('emergency') ? 'has-error' : '' }}">
                                ...
                                {!! Form::select('emergency', $emergency, old('emergency'), ['class' => 'form-control', 'data-toggle'=>'select2']) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('level') ? 'has-error' : '' }}">
                                ...
                                {!! Form::select('level', $dec_level, old('level'), ['class' => 'form-control', 'data-toggle'=>'select2']) !!}
                                @if($errors->has('level'))
                                    <div class="mt-1 require_error">
                                        {{ $errors->first('level') }}
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('tlp') ? 'has-error' : '' }}">
                                ...
                                {!! Form::select('tlp', $tlp, old('tlp'), ['class' => 'form-control', 'data-toggle'=>'select2']) !!}
                                @if($errors->has('level'))
                                    <div class="mt-1 require_error">
                                        {{ $errors->first('tlp') }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('pap') ? 'has-error' : '' }}">
                                ...
                                {!! Form::select('pap', $pap, old('pap'), ['class' => 'form-control', 'data-toggle'=>'select2']) !!}
                                @if($errors->has('pap'))
                                    <div class="mt-1 require_error">
                                        {{ $errors->first('pap') }}
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{ $errors->has('tech_detail') ? 'has-error' : '' }}">
                                ...
                                <textarea class="form-control" rows="8" name="tech_detail">{{ old('tech_detail') }}</textarea>
